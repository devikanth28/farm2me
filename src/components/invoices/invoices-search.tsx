...
const InvoicesSearch: React.FC<SearchPanelProps> = ({ onSearch }) => {
    ...
    const [openOrders, setOpenOrders] = useState<boolean>(true);
    ...
    const handleSearch = () => {
        ...
        onSearch(searchFilter, openOrders);        
    }    
    ...
    return (
        <div className="col-12">
            <div className="card border-noround p-2" style={{ minHeight: '9rem'}}>
                ...
                <div className="border-round ml-2" style={{ float: "left", textAlign:'center', width: "23%" }}>
                    <div className="ml-8" style={{ width:'70%'}}>                        
                        <div style={{float: "left"}}><InputSwitch inputId="input-metakey" checked={openOrders} onChange={(e: InputSwitchChangeEvent) => setOpenOrders(e.value!)} /></div>                        
                        <div className='ml-1' style={{float: "left"}}><label htmlFor="input-metakey">Open Orders</label></div> 
                    </div>
                </div>
                <br /><br />                        
                <div className="font-bold text-white border-round"  style={{ float: "left", width: "25%" }}>
